function dataset = read_json(filename, varargin)
    % dataset = read_json(filename, varargin)
    % 
    % Loads datasetset written to disk in JSON format.
    %
    % Inputs
    % ------
    %
    ...
    dataset = jsonlab.loadjson(text, opts);
